                  ...
                  <div class="modal-content">
                    <div class="modal-body card-header">
                      <div class="text-xs-center" style="padding: 0px">
                        <a href="{{ route('customers') }}"><h5>مشتریان</h5>
                        <div class="cm-icon bg-success  mb-1"><i class="fa fa-group"></i></div></a>
                        <div class="row ">
                          <div class="col-xs-6">
                            <a href="{{ route('addCustomer') }}"><button  class="btn btn-success btn-block">
                              <li class="fa fa-user-plus"></li>  افزودن
                            </button></a>
                          </div>
                          <div class="col-xs-6">
                            <a href="{{ route('customers') }}"><button type="button" class="btn btn-success ">
              ...
              <div class="modal static-modal custom-modal-5 ">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-body card-header">
                      <div class="text-xs-center" style="padding: 0px">
                        <a href="{{ route('files') }}"><h5>فایل ها</h5>
                        <div class="cm-icon bg-primary  mb-1"><i class="fa fa-file"></i></div></a>
                        <div class="row ">
                          <div class="col-xs-6">
                            <a href="{{ route('addFile') }}"><button  class="btn btn-primary btn-block">
                              <li class="fa fa-plus-circle"></li>  افزودن
                            </button></a>
                          </div>
                          <div class="col-xs-6">
                            <a href="{{ route('files') }}"><button type="button" class="btn btn-primary ">
              ...
              <div class="modal static-modal custom-modal-5 ">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-body card-header">
                      <div class="text-xs-center" style="padding: 0px">
                        <a href="{{ route('contracts') }}"><h5>قراردادها</h5>
                        <div class="cm-icon bg-info  mb-1"><i class="fa fa-book"></i></div></a>
                        <div class="row ">
                          <div class="col-xs-6">
                            <a href="{{ route('addContract') }}"><button  class="btn btn-info btn-block">
                              <li class="fa fa-edit"></li>  افزودن
                            </button></a>
                          </div>
                          <div class="col-xs-6">
                            <a href="{{ route('contracts') }}"><button type="button" class="btn btn-info btn-block">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
              <div class="box box-block tile tile-2 bg-success mb-2">
                ...
                <div class="t-content">
                  <h1 class="mb-1">{{$myCustomersCount}}</h1>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
              <div class="box box-block tile tile-2 bg-info  mb-2">
                ...
                <div class="t-content">
                  <h1 class="mb-1">{{$myContractsCount}}</h1>
