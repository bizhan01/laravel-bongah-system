      ...
      <tbody>
        ...
        @foreach($contracts as $row => $contract)
          <tr>
            ...
            <td>{{number_format($contract->advance_paid)}}</td>
            <td>{{number_format($contract->rent)}}</td>
            <td>{{ $contract->contract_code}}</td>
            <td>{{number_format($contract->commission)}}</td>
...
<!-- Print Report -->
<a href="{{ route('printContractReport') }}" class="btn btn-inverse waves-effect waves-light">
