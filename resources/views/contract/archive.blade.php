<!-- Archive  -->
<div class="modal fade" id="archive_{{ $contract->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
