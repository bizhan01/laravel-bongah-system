<!-- Archive  -->
<div class="modal fade" id="archive_{{ $file->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
        			<div class="container">
          			<form method="POST" action="/archiveFile/{{ $file->id}}">
