            ...
            <div class="pv-content">
              ...
              <table class="table mb-md-0">
                ...
                <tr class="table-warning">
                  <td>قیمت</td>
                  <th>{{ number_format($file[0]->price)}}  <span style="color: blue">تومان</span></th>
                  <td>طبقه</td>
                  <th><?php echo $file[0]->stage; ?></th>
                </tr>
                <tr class="table-success">
                  <td>پول پیش</td>
                  <th>{{ number_format($file[0]->advance_paid)}} <span style="color: blue">تومان</span></th>
                  <td>تاریخ ساخت</td>
                  <th><?php echo $file[0]->manufacture_date; ?></th>
                </tr>
                <tr class="table-info">
                  <td>کرایه</td>
                  <th>{{ number_format( $file[0]->rent)}} <span style="color: blue">تومان</span></th>
                  <td>تاریخ تحویل</td>
