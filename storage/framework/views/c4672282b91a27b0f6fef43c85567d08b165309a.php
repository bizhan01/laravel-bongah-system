      ...
      <div class="col-lg-8 col-md-4 col-sm-6 col-xs-12">
        <div class="box box-block bg-white">
          <div class="box box-block bg-white">
            ...
            <p class="mb-0-5">ریاست <span class="float-xs-right"><?php echo e($x1 / $y1); ?>%</span></p>
            <progress class="progress progress-success progress-sm" value="<?php echo e($x1 / $y1); ?>" max="100">100%</progress>
            <p class="mb-0-5">کریگولم <span class="float-xs-right"><?php echo e($x2 / $y2); ?>%</span></p>
            <progress class="progress progress-danger progress-sm" value="<?php echo e($x2 / $y2); ?>" max="100">100%</progress>
            <p class="mb-0-5">محیط درسی<span class="float-xs-right"><?php echo e($x3 / $y3); ?>%</span></p>
            <progress class="progress progress-info progress-sm" value="<?php echo e($x3 / $y3); ?>" max="100">100%</progress>
            <p class="mb-0-5">کارمندان اداری<span class="float-xs-right"><?php echo e($x4 / $y4); ?>%</span></p>
            <progress class="progress progress-primary progress-sm" value="<?php echo e($x4 / $y4); ?>" max="100">100%</progress>
            <p class="mb-0-5">فیس و مالی<span class="float-xs-right"><?php echo e($x5 / $y5); ?>%</span></p>
            <progress class="progress progress-success progress-sm" value="<?php echo e($x5 / $y5); ?>" max="100">100%</progress>
            <p class="mb-0-5">سایر موارید<span class="float-xs-right"><?php echo e($x6 / $y6); ?>%</span></p>
            <progress class="progress progress-primary progress-sm mb-0" value="<?php echo e($x6 / $y6); ?>" max="100">100%</progress>
          </div>
        </div>
      </div>
