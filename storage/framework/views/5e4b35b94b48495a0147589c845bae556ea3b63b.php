						...
						<?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								...
								<td style="display: flex; flex-direction: row; justify-content: center;">
									<a href="<?php echo e(url('projectExpense').'/' .$project->project_id); ?>" title="مصارف">
										<i class="ti-bar-chart-alt text-info"></i>
									</a>
									&nbsp;&nbsp;&nbsp;
									<a href="<?php echo e(url('editProject').'/' .$project->project_id); ?>" title="ویرایش">
										<i class="ti-pencil-alt"></i>
									</a>
									&nbsp;&nbsp;&nbsp;
									<a href="#completed_<?php echo e($project->project_id); ?>" title="بایگانی" data-toggle='modal'>
										<i class="fa fa-check text-success"></i>
									</a>
	                <?php echo $__env->make('project.completed', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
									&nbsp;&nbsp;&nbsp;
									<a href="<?php echo e(url('deleteProject').'/' .$project->project_id); ?>" title="حذف" onclick='return confirm("آیا مطمیین استید که حذف شود ؟")'>
