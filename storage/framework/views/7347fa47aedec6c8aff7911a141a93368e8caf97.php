			...
			<div class="">
						...
						<div class="card">
							...
							<div class="card-block">
						        ...
						        <tr>
						          ...
						          <th><span> </span>مالک پروژه</th>
						          <th><span> </span>نوع پروژه</th>
						      ...
						      <tbody>
						        <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						          <tr>
						            ...
						            <td><span> </span><?php echo e($project->date); ?></td>
						            <td><span> </span><?php echo e($project->user_name); ?></td>
						            <td><span> </span><?php echo e($project->prefix); ?> <?php echo e($project->name); ?></td>
						            <td><span> </span><?php echo e($project->project_type); ?></td>
						            <td><span> </span><?php echo e($project->location); ?></td>
						            <td><span> </span><?php echo e($project->space); ?></td>
						            <td><span> </span><?php echo e($project->start_date); ?></td>
						            <td><span> </span><?php echo e($project->end_date); ?></td>
						          </tr>
						        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						      </tbody>
								</table>
                ...
                <a href="javascript:window.print()" class="btn btn-inverse waves-effect waves-light">
  							<button type="button" class="btn btn-info label-left float-xs-right mr-0-5">
									...
									<a href="<?php echo e(route('projectReport')); ?>"><button type="button" class="btn-warning" name="button" >برگشت</button></a>
							</div>
						</div>
					</div>
				</div>
