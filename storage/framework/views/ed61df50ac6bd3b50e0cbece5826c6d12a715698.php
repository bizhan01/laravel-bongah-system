	...
	<div class="container-fluid">
			...
			<form class="" action="index.html" method="post">
				<div class="row">
					<div class="col-md-10">
					    ...
					    <input type="text" id="pcal1" class="form-control pdate">
					  </div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label>تاریخ ختم<span style="color: red">*</span></label>
							<input type="date" class="form-control" name="lastName"  required>
							<span class="font-90 text-muted"></span>
						</div>
					</div>
		...
		<script type="text/javascript">
			...
			var objCal4 = new AMIB.persianCalendar( 'pcal4', {
					onchange: function( pdate ){ alert( pdate.join( '/' ) ); }
				}
			);
