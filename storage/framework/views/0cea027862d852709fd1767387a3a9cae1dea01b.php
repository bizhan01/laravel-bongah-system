<!-- Archive  -->
<div class="modal fade" id="archive_<?php echo e($file->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
        			<div class="container">
          			<form method="POST" action="/archiveFile/<?php echo e($file->id); ?>">
                  <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                  <center class="modal-body">
                  	<p class="text-center">آیا مطمین به بایگانی این مورد استید؟</p>
            				<h2 class="text-center"><?php echo e($file->id); ?></h2>
            			</center>
