<!-- project completed -->
<div class="modal fade" id="completed_<?php echo e($project->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
        			<div class="container">
          			<form method="POST" action="/isCompleted/<?php echo e($project->id); ?>">
                  <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                  <center class="modal-body">
                  	<p class="text-center">آیا مطمین به بایگانی این مورد استید؟</p>
            				<h2 class="text-center"><?php echo e($project->id); ?></h2>
            			</center>
