<div class="box box-block bg-white">
  <div class="overflow-x-auto">
    <table class="table table-striped table-bordered dataTable" id="table-2">
      ...
      <tbody>
        <?php $__currentLoopData = $archivedFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
