		...
		<div class="row">
			<div class="col-sm-4 col-md-3">
				<div class="card profile-card">
					...
					<ul class="list-group">
						<li class="list-group-item"><span style="color: #7f9d18"  class="fa fa-heartbeat"> وظیفه:</span> <b>
			...
			<div class="col-sm-8 col-md-9">
				...
				<div class="card mb-0">
					<ul class="nav nav-tabs nav-tabs-2 profile-tabs" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#change-password" role="tab">تغییر رمز عبور</a>
						</li>
					</ul>
