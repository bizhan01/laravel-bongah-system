          ...
          <div class="col-md-8 col-sm-7">
            <div class="pv-content">
              ...
              <table class="table mb-md-0">
                ...
                <tr class="table-success">
                  <td>قیمت</td>
                  <th colspan="3"><?php echo e(number_format($contract[0]->price)); ?>  <span style="color: blue">تومان</span></th>
                </tr>
                <tr class="table-info">
                  <td>پول پیش</td>
                  <th colspan="3"><?php echo e(number_format($contract[0]->advance_paid)); ?> <span style="color: blue">تومان</span></th>
                </tr>
                <tr class="table-success">
                  <td>کرایه</td>
                  <th colspan="3"><?php echo e(number_format( $contract[0]->rent)); ?> <span style="color: blue">تومان</span></th>
                </tr>
              </table>
            </div>
          </div>
