        ...
        <div class="box bg-white user-1">
          ...
          <div class="u-content">
            ...
            <div class="text-xs-center pb-0-5">
              <a href="<?php echo e(route('profile')); ?>"><button type="submit" class="btn btn-success btn-rounded mr-0-5"><i class="ti-user mr-0-5"></i> پروفایل</button></a>
    ...
    <div class="row row-md">
      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
        <div class="box box-block tile tile-2 bg-danger mb-2">
          ...
          <div class="t-content">
            <h1 class="mb-1"><?php echo e($allProjectsCount); ?></h1>
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
        <div class="box box-block tile tile-2 bg-primary mb-2">
          ...
          <div class="t-content">
            <h1 class="mb-1"><?php echo e($completedProjects); ?></h1>
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
        <div class="box box-block tile tile-2 bg-success mb-2">
          ...
          <div class="t-content">
            <h1 class="mb-1"><?php echo e($uncompletedProjects); ?></h1>
